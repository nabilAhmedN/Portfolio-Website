...
(() =>{
    ...
    function fadeOutFffect(){
        document.querySelector(".fade-out-effect").classList.add("active");
        setTimeout(() =>{
            document.querySelector(".fade-out-effect").classList.remove("active");
        },300)
    }
    // attach an envet handler to document
    document.addEventListener("click", (event) =>{
        if(event.target.classList.contains('link-item')){
            /* make sure event.target.hash has a value brfore overrider default behavior */
...
(()=>{
    ...
    portfolioItemsContainer.addEventListener("click", (event) =>{
        if(event.target.closest(".portfolio-item-inner")){
            ...
            // convert screenshots into arrys
    ...
    function popupSlidershow(){
        ...
        popup.querySelector(".pp-loader").classList.add("adtive");
        popupImg.src = imgSrc;
        popupImg.onload = () =>{
